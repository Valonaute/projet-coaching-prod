...
class getAdminSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Hkx_Un2'] ?? $container->load('get_ServiceLocator_HkxUn2Service'))->withContext('App\\Controller\\AdminSecurityController', $container));
